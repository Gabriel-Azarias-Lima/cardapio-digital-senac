                        ...
                        <div id="enderecoArea" class="mb-4" style="display: none;">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="enderecoRua" placeholder="Rua" />
                                </div>
                                <div class="col-md-2">
                                    <label for="enderecoNumero" class="form-label">Número *</label>
                                    <input type="text" class="form-control" id="enderecoNumero" placeholder="Nº" />
                                </div>
                                <div class="col-md-4">
                                    <label for="enderecoBairro" class="form-label">Bairro *</label>
                                    <input type="text" class="form-control" id="enderecoBairro" placeholder="Bairro" />
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label for="enderecoReferencia" class="form-label">Referência</label>
                                    <input type="text" class="form-control" id="enderecoReferencia" placeholder="Ponto de referência (opcional)" />
                                </div>
                                <div class="col-12">
                                    <label for="enderecoObservacoes" class="form-label">Observações</label>
                                    <textarea class="form-control" id="enderecoObservacoes" rows="2" placeholder="Complemento, bloco, apartamento..."></textarea>
                                </div>
                            </div>
                        </div>
